                        ...
                        <tr>
                            ...
                            <td >
                                <?php if($item->assignments): ?>
                                    ...
                                    <?php foreach($item->assignments as $assignment ): ?>
                                        <span class="label label-sm label-success"><?=$assignment['description']; ?></span>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </td>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a class="btn btn-default" type="button" href="<?=Yii::$app->urlManager->createUrl(['user/uedit','id' => $item['id']]); ?>">编辑</a>
