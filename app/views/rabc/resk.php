...
<div class="row">
    <div class="col-sm-12">
        <div class="form-group">
            ...
            <a class="btn btn-primary" href="<?= Yii::$app->urlManager->createUrl(['rabc/rcreate']) ?>" role="button">添加资源</a>
        </div>
    </div>
</div>
                ...
                <table class="table  table-hover ">
                    ...
                    <?php foreach($list as $key => $item): ?>
                        <tr>
                            ...
                            <td>
                                <span class="label label-danger arrowed"><?= empty($item->topmenu) ? "": $item->topmenu['name']; ?></span>
                            </td>
